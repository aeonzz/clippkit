...
<ComponentFileExplorer
  expandLink="/usage/u-circular-loader"
  files={[
    {
      name: "app",
    ...
    },
    {
      name: "components",
      children: [
        { name: "clippkit", children: [{ name: "circular-loader.tsx" }] },
      ],
    },
  ]}
>
  <ComponentCode name="circular-loader-demo" />
  <ComponentCode name="circular-loader" />
</ComponentFileExplorer>
