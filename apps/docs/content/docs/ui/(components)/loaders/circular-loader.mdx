...
<Steps>
  <Step>
    Create a new file, for example, at `src/components/circular-loader.tsx` (or your preferred location) and paste the following code into it.
    
    ```tsx title="src/components/circular-loader.tsx"
    "use client";
