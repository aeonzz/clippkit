...
<Callout title="COMING SOON" type="warn">
  Installation via `npx shadcnui install clipkittt@circular-waveform` isn't quite ready yet.
...
The GitHub task can be [found here.](https://github.com/reactvideoeditor/clippkit/issues/YOUR_ISSUE_NUMBER_HERE) {/* Adjust if you have a specific issue for this component */}
